import 'package:engine_group_isolate_test/flutter_engine_group_isolate.dart';
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ElevatedButton(
              onPressed: () async {
                await FlutterIsolate.spawn<int>(spawn_with_engine_group, DateTime.now().millisecondsSinceEpoch);
              },
