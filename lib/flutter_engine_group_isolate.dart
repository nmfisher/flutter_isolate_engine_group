...
class FlutterIsolate {
  ...
  static Future<FlutterIsolate> spawn<T>(
    ...
    _control.invokeMethod("spawn_isolate", {
      "entry_point_filename":"package:engine_group_isolate_test/flutter_engine_group_isolate.dart",
      "entry_point":"_flutterIsolateEntryPoint",
  ...
  static final _control = MethodChannel("com.avinium.engine_isolate/control");
  static final _event = EventChannel("com.avinium.engine_isolate/event");
